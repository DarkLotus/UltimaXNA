...
namespace UltimaXNA.Data
{
	...
	{
		public static LandData[] LandData{get { return td.LandTable;}}// = new LandData[0x4000];
		public static ItemData[] ItemData {get{ return td.ItemTable;}}// = new ItemData[0x4000];

		public static ItemData ItemData_ByAnimID(int animID)
		{
			for (int i = 0; i < ItemData.Length; i++)
			{
				if (ItemData[i].Animation == animID)
					return ItemData[i];
			}
			return new ItemData();
		}
		...
		// Issue 5 - End
		private static OpenUO.Ultima.TileData td;
		static TileData()
		{
